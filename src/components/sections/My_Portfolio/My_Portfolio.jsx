  ...
  return (
    <>
      <div className="container">
        <div className="mb-10">
          <Section_Title text="My Portfolio" className="mx-auto" />
          <Section_Header
            text="My Work Example"
        ...
        <Tabs>
          ...
          <TabPanel className="!grid grid-cols-2 gap-4 py-20">
            <Work_Box ImgSrc={img2} text="Motion Graphics" ptext="Website" />
            <Work_Box ImgSrc={img1} text="E-Learning App" ptext="IOS App" />
            <Work_Box ImgSrc={img2} text="Motion Graphics" ptext="Website" />
            <Work_Box ImgSrc={img1} text="E-Learning App" ptext="IOS App" />
          </TabPanel>
          <TabPanel>
